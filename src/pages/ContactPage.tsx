        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-16">
            {contactInfo.map((info, index) => (
              <div 
                key={index}
                className="glass rounded-2xl p-6 border border-white/60 hover:shadow-xl transition-all duration-300 text-center"
              >
                ...
                <h3 className="text-xl font-display font-bold mb-2 text-bit-dark">
                  {info.title}
                </h3>
                <p className="text-sm text-bit-dark/60 mb-2">
                  {info.description}
                </p>
                <p className="text-sm font-semibold text-bit-lavender">
                  {info.detail}
                </p>
              </div>
            ))}
                ...
                <div className="relative z-10">
                  ...
                  <div className="space-y-6">
                    <div className="flex gap-4">
                      ...
                      <div>
                        <h4 className="font-bold text-white text-lg mb-1">For Parents & Students</h4>
                        <p className="text-sm text-white/80 leading-relaxed">
                          Learn more about our programs, application process, and upcoming cohorts.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex gap-4">
                      <div className="w-2 h-2 rounded-full bg-white mt-2 shrink-0"></div>
                      <div>
                        <h4 className="font-bold text-white text-lg mb-1">For Volunteers</h4>
                        <p className="text-sm text-white/80 leading-relaxed">
                          Interested in mentoring or contributing? We'd love to have you on board.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex gap-4">
                      <div className="w-2 h-2 rounded-full bg-white mt-2 shrink-0"></div>
                      <div>
                        <h4 className="font-bold text-white text-lg mb-1">For Partners</h4>
                        <p className="text-sm text-white/80 leading-relaxed">
                          Explore collaboration opportunities and how we can work together.
                        </p>
                      </div>
                    </div>
                  </div>
